...
export default function ContractForm() {
  ...
  return (
    <div className="p-6">
      <div className="max-w-3xl mx-auto">
        {/* Back Button */}
        <Link to={createPageUrl(`Product?id=${product.id}`)} className="inline-flex items-center gap-2 text-orange-600 hover:text-orange-800 mb-8 font-medium">
        ...
        <Card className="shadow-xl border-orange-200">
          <CardHeader className="bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-t-lg">
            ...
            <p className="text-orange-100 mt-2">מלא את הפרטים ליצירת חוזה דיגיטלי מאובטח</p>
          </CardHeader>
          ...
          <CardContent className="p-8 space-y-8">
            ...
            <Card className="bg-orange-50 border-orange-200">
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <span className="font-semibold text-gray-700">פיקדון:</span>
                    <p className="text-gray-900">{product.deposit_amount}₪</p>
                  </div>
                  <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="tenant_email" className="text-sm font-semibold">כתובת אימייל *</Label>
                  <Input
                    id="tenant_email"
                    type="email"
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="deposit_amount" className="text-sm font-semibold">סכום פיקדון (₪)</Label>
                    <Input
                      id="deposit_amount"
                      type="number"
                      value={product.deposit_amount}
                      className="border-orange-200 bg-gray-100"
                      disabled
                      readOnly
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="damage_compensation_amount" className="text-sm font-semibold">סכום פיצוי על נזק (₪)</Label>
                    <Input
                      id="damage_compensation_amount"
                      type="number"
                      value={product.damage_compensation_amount}
                      className="border-orange-200 bg-gray-100"
                      disabled
                      readOnly
                    />
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center border-t pt-3">
                        ...
                        <span className="font-bold text-lg">{product.deposit_amount}₪</span>
                      </div>
                      <div className="flex justify-between items-center font-bold text-xl border-t pt-3">
                        <span>סה"כ לתשלום:</span>
                        <span className="text-orange-600">{calculateTotal() + product.deposit_amount}₪</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-green-700 space-y-1">
                        <li className="flex items-center gap-2">
                          ...
                          החוזה יישלח אוטומטית לאימייל שלך ושל המשכיר
                        </li>
                        <li className="flex items-center gap-2">
                          <CheckCircle className="w-4 h-4" />
